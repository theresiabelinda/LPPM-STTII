...
@section('content')
            ...
            <div class="col-lg-10">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Daftar Dokumen Resmi.</p>
                    </div>
                ...
                {{-- List Dokumen (Bentuk Tabel Bersih) --}}
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                @forelse($dokumenlainnya as $item)
                                    <tr class="doc-item">
                                        <td class="ps-4 py-3">
                                        ...
                                        <td class="pe-4 text-end">
                                            <a href="{{ asset('storage/dokumenlainnya_pdf/' . $item->path_file) }}" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill px-3">
    ...
    {{-- Script Search Tetap Ada (Fungsional) --}}
    <script>
